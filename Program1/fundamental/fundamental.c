...
int main(){
   ...
   Pupil student= {"Olukayode", 1234, 'M'};
...
int main(){
   ...
   FILE *pF = fopen("C:\\Users\\OLUKAYODE IFE\\Desktop\\Cnote.txt", "w");

   fprintf(pF, "My name is Ifeoluwa. I am writting with \'C\'");
...
int main(){
   ...
   FILE *pF = fopen("C:\\Users\\OLUKAYODE IFE\\Desktop\\Cnote.html", "r");
   char buffer[255];
